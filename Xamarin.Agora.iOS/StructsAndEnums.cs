...
namespace DT.Xamarin.Agora
{
    ...
    [Native]
    public enum AgoraVideoSRMode : ulong
    {
        Manual = 0,
        Auto = 1
    }
    ...
    [Native]
    public enum AgoraLocalProxyMode : ulong
    {
        ConnectivityFirst = 0,
        LocalOnly = 1
    }
    ...
    [Native]
    public enum AgoraAudioMixingDualMonoMode : ulong
    {
        Auto,
        L,
        R,
    ...
    [Native]
    public enum AgoraAudioDeviceTestVolumeType : long
    {
        RecordingVolume = 0,
        PlaybackVolume = 1
    }
